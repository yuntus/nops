...
function(e, t) {
	...
	return function(e) {
		...
		}, a = n(6), o = n(26), r = Object.prototype.toString;
		...
		function u(e, t) {
			if (null !== e && void 0 !== e) if ("object" !== (void 0 === e ? "undefined" : i(e)) && (e = [e]), s(e)) for (var n = 0, a = e.length; n < a; n++) t.call(null, e[n], n, e);
	...
	default = a
		...
		(function(t) {
			...
			var s = {
				adapter: function() {
					var e;
					return "undefined" != typeof XMLHttpRequest ? e = n(7) : void 0 !== t && (e = n(7)), e
				}(),
		...
		var E = 0,
			...
			q = function() {
				function e(t) {
					...
					}(this, e), this.options = (0, r.
				default)(t), this.options.video.quality && (this.qualityIndex = this.options.video.defaultQuality, this.quality = this.options.video.quality[this.options.video.defaultQuality]), this.tran = new s.
				default (this.options.lang).tran, this.events = new d.
				default, this.user = new h.
				default (this), this.container = this.options.container, this.container.classList.add("dplayer"), this.options.danmaku || this.container.classList.add("dplayer-no-danmaku"), this.options.live && this.container.classList.add("dplayer-live"), o.
				default.isMobile && this.container.classList.add("dplayer-mobile"), this.arrow = this.container.offsetWidth <= 500, this.arrow && this.container.classList.add("dplayer-arrow"), this.template = new l.
				default ({
						container: this.container,
						options: this.options,
						index: E,
						tran: this.tran
					}), this.video = this.template.video, this.bar = new y.
				default (this.template), this.bezel = new v.
				default (this.template.bezel), this.fullScreen = new p.
				default (this), this.controller = new g.
				default (this), this.options.danmaku && (this.danmaku = new u.
				default ({
				...
				default (this)), this.setting = new b.
				default (this), document.addEventListener("click", function() {
						n.focus = !1
					}, !0), this.container.addEventListener("click", function() {
						n.focus = !0
					}, !0), this.paused = !0, this.timer = new m.
				default (this), this.hotkey = new k.
				default (this), this.contextmenu = new x.
				default (this), this.p2pInfo = {
						version: "",
						downloaded: 0,
						uploaded: 0,
						peerId: "",
						peers: 0
					}, this.initVideo(this.video, this.quality && this.quality.type || this.options.video.type), this.infoPanel = new S.
				default (this), !this.danmaku && this.options.autoplay && this.play(), E++, M.push(this)
				}
				return i(e, [{
					key: "seek",
					value: function(e) {
						e = Math.max(e, 0), this.video.duration && (e = Math.min(e, this.video.duration)), this.video.currentTime < e ? this.notice(this.tran("FF") + " " + (e - this.video.currentTime).toFixed(0) + " " + this.tran("s")) : this.video.currentTime > e && this.notice(this.tran("REW") + " " + (this.video.currentTime - e).toFixed(0) + " " + this.tran("s")), this.video.currentTime = e, this.danmaku && this.danmaku.seek(), this.bar.set("played", e / this.video.duration, "width"), this.template.ptime.innerHTML = o.
					...
					key: "pause",
					value: function() {
						this.paused = !0, this.container.classList.remove("dplayer-loading"), this.video.paused || this.bezel.
						switch (c.
					default.pause), this.template.playButton.innerHTML = c.
					default.play, this.video.pause(), this.timer.disable("loading"), this.container.classList.remove("dplayer-playing"), this.container.classList.add("dplayer-paused"), this.danmaku && this.danmaku.pause()
					}
				}, {
					...
					value: function(e, t) {
						...
						case "hls":
							...
							if (i.p2pConfig || (i.p2pConfig = {}), i.p2pConfig.tag || (i.p2pConfig.tag = "p2p-dplayer"), Hls) if (Hls.isSupported()) {
								var a = new Hls(i);
								a.loadSource(e.src), a.attachMedia(e), this.hlsjs = a, this.setupP2PListeners(a)
					...
					value: function(e, t) {
						...
						this.volume(this.user.get("volume"), !0, !0), this.options.subtitle && (this.subtitle = new f.
					...
					value: function(e) {
						var t = this;
						this.p2pInfo.version = e.p2pEngine.version, e.p2pEngine.on("stats", function(e) {
							t.p2pInfo.downloaded = e.totalP2PDownloaded, t.p2pInfo.uploaded = e.totalP2PUploaded, t.events.trigger("stats", e)
						}).on("peerId", function(e) {
							t.p2pInfo.peerId = e, t.events.trigger("peerId", e)
						}).on("peers", function(e) {
							t.p2pInfo.peers = e.length, t.events.trigger("peers", e)
						})
					}
				}], [{
					key: "version",
	...
	default = q
		...
		(function(e) {
			...
			}, n(20), t.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== e && e.setImmediate || void 0, t.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== e && e.clearImmediate || void 0
		}).call(this, n(2))
	}, function(e, t, n) {
		"use strict";
		(function(e, t) {
	...
	default = function(e) {
			...
			return e.video && !e.video.type && (e.video.type = "auto"), "object" === i(e.danmaku) && e.danmaku && !e.danmaku.user && (e.danmaku.user = "DIYgod"), e.subtitle && (!e.subtitle.type && (e.subtitle.type = "webvtt"), !e.subtitle.fontSize && (e.subtitle.fontSize = "20px"), !e.subtitle.bottom && (e.subtitle.bottom = "40px"), !e.subtitle.color && (e.subtitle.color = "#fff")), e.video.quality && (e.video.url = e.video.quality[e.video.defaultQuality].url), e.lang && (e.lang = e.lang.toLowerCase()), e.contextmenu = e.contextmenu.concat([{
				...
				text: "Video Player | ZUIBAQI",
				link: "https://www.zuibaqi.com"
			}, {
				text: "version v1.25.0",
				link: ""
			}]), e
		}
	}, function(e, t, n) {
	...
	default = {
		...
		}, l.Cancel = n(10), l.CancelToken = n(41), l.isCancel = n(9), l.all = function(e) {
			return Promise.all(e)
		}, l.spread = n(42), e.exports = l, e.exports.
	default = l
	}, function(e, t, n) {
		"use strict";
					...
					value: function(e) {
						...
						if (this.showing) {
							var n = this.options.height,
								...
								u = function(e, n, o) {
									for (var r = a / c(o), u = function(i) {
											...
											if (!o || !o.length) return t.danTunnel[n][i + ""] = [e], e.addEventListener("animationend", function() {
											...
											for (var u = 0; u < o.length; u++) {
												...
												if (u === o.length - 1) return t.danTunnel[n][i + ""].push(e), e.addEventListener("animationend", function() {
													t.danTunnel[n][i + ""].splice(0, 1)
												}), {
													v: i % s
												}
							...
							for (var d = document.createDocumentFragment(), p = function(i) {
									e[i].type = o.
								default.number2Type(e[i].type), e[i].color || (e[i].color = 16777215);
									var r = document.createElement("div");
									r.classList.add("dplayer-danmaku-item"), r.classList.add("dplayer-danmaku-" + e[i].type), e[i].border ? r.innerHTML = '<span style="border:' + e[i].border + '">' + e[i].text + "</span>":
									r.innerHTML = e[i].text, r.style.opacity = t._opacity, r.style.color = o.
								default.number2Color(e[i].color), r.addEventListener("animationend", function() {
	...
	default = a
		...
		var o = function() {
				function e(t) {
					...
					var i = function() {
							n.player.resize(), n.isFullScreen("browser") ? n.player.events.trigger("fullscreen") : (a.
	...
	default = a
		...
		var l = function() {
				function e(t) {
					...
					function(e, t) {
						if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
					}(this, e), this.player = t, this.autoHideTimer = 0, a.
				default.isMobile || (this.player.container.addEventListener("mousemove", function() {
						...
						n.setAutoHide()
					})), this.initPlayButton(), this.initThumbnails(), this.initPlayedBar(), this.initFullButton(), this.initQualityButton(), this.initScreenshotButton(), this.initSubtitleButton(), this.initHighlights(), a.
				...
				return i(e, [{
					...
					value: function() {
						var e = this,
							...
							default.getBoundingClientRectViewLeft(e.player.template.playedBarWrap)) / e.player.template.playedBarWrap.clientWidth;
								n = Math.max(n, 0), n = Math.min(n, 1), e.player.bar.set("played", n, "width"), e.player.template.ptime.innerHTML = a.
					...
					default.nameMap.dragStart, function() {
							e.player.timer.disable("progress"), document.addEventListener(a.
					...
					default.nameMap.dragMove, function(t) {
							...
							default.cumulativeOffset(e.player.template.playedBarWrap).left,
								...
								a.
							default.isMobile && e.thumbnails && e.thumbnails.show(), e.thumbnails && e.thumbnails.move(i), e.player.template.playedBarTime.style.left = i - (o >= 3600 ? 25 : 20) + "px", e.player.template.playedBarTime.innerText = a.
							default.secondToTime(o), e.player.template.playedBarTime.classList.remove("hidden")
							}
						}), this.player.template.playedBarWrap.addEventListener(a.
					...
					value: function() {
						var e = this,
							...
							n = function n() {
								document.removeEventListener(a.
							default.nameMap.dragEnd, n), document.removeEventListener(a.
							default.nameMap.dragMove, t), e.player.template.volumeButton.classList.remove("dplayer-volume-active")
							};
					...
					default.nameMap.dragStart, function() {
						...
						default.nameMap.dragMove, t), document.addEventListener(a.
						default.nameMap.dragEnd, n), e.player.template.volumeButton.classList.add("dplayer-volume-active")
				...
				function e(t) {
					...
					if (this.player.danmaku) {
						...
						var r = function(e) {
							...
							s = function e() {
								document.removeEventListener(a.
							default.nameMap.dragEnd, e), document.removeEventListener(a.
							default.nameMap.dragMove, r), n.player.template.danmakuOpacityBox.classList.remove("dplayer-setting-danmaku-active")
							};
					...
					default.nameMap.dragStart, function() {
							document.addEventListener(a.
						default.nameMap.dragMove, r), document.addEventListener(a.
						default.nameMap.dragEnd, s), n.player.template.danmakuOpacityBox.classList.add("dplayer-setting-danmaku-active")
						})
					}
				}
				return i(e, [{
				...
				return i(e, [{
					...
					value: function() {
						...
						default.color2Number(this.player.container.querySelector(".dplayer-comment-setting-color input:checked").value),
							type:
							parseInt(this.player.container.querySelector(".dplayer-comment-setting-type input:checked").value)
						}, function() {
	...
	default = a
		...
		var a = function() {
				...
				return i(e, [{
					...
					key: "update",
					value: function() {
						this.template.infoVersion.innerHTML = "v1.25.0 b770027", this.template.infoType.innerHTML = this.player.type, this.template.infoUrl.innerHTML = this.player.options.video.url, this.template.infoResolution.innerHTML = this.player.video.videoWidth + " x " + this.player.video.videoHeight, this.template.infoDuration.innerHTML = this.player.video.duration, this.player.options.danmaku && (this.template.infoDanmakuId.innerHTML = this.player.options.danmaku.id, this.template.infoDanmakuApi.innerHTML = this.player.options.danmaku.api, this.template.infoDanmakuAmount.innerHTML = this.player.danmaku.dan.length), this.template.infoP2pVersion.innerHTML = this.player.hlsjs ? "v" + this.player.p2pInfo.version : "", this.template.infoP2pDownloaded.innerHTML = (this.player.p2pInfo.downloaded / 1e3).toFixed(2) + "MB", this.template.infoP2pUploaded.innerHTML = (this.player.p2pInfo.uploaded / 1e3).toFixed(2) + "MB", this.template.infoPeerid.innerHTML = "" + this.player.p2pInfo.peerId, this.template.infoPeers.innerHTML = "" + this.player.p2pInfo.peers
					}
				}, {
					key: "fps",
					value: function(e) {
